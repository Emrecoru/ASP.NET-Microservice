...
namespace AccountService.API.Controllers
{
    ...
    public class AccountsController : ControllerBase
    {
        ...
        {
            var result = await playerRepository.Create(new Data.Entities.Player { FirstName = dto.FirstName, LastName = dto.LastName, Username = dto.Username });
        ...
        {
            await playerRepository.Update(new Data.Entities.Player { Id = dto.Id, FirstName = dto.FirstName, LastName = dto.LastName, Username = dto.Username });
